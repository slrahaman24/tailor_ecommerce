            ...
            <tbody>
                @foreach($categories as $key => $category)
                    <tr>
                        ...
                        <td><img loading="lazy"  class="img-md" src="{{ asset($category->banner) }}" alt="{{translate('banner')}}"></td>
                        <td><img loading="lazy"  class="img-xs" src="{{ asset($category->icon) }}" alt="{{translate('icon')}}"></td>
