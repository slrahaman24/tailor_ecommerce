<div class="header bg-white">
            ...
            <div class="row">
                ...
                <div class="col-5 text-right d-none d-lg-block">
                    <ul class="inline-links">
                        ...
                        <li>
                            <a href="Javascript:" onclick="return get_location();" class="top-bar-item">{{ translate('Location')}}</a>
                        </li>
                        @endauth
                    </ul>
                </div>
    ...
    <div class="position-relative logo-bar-area">
        ...
        <div class="get_location" id="get_location">
            <div class="container">
                <div class="row no-gutters position-relative">
                    <div class="col-lg-3 position-static">
                        <div class="category-sidebar1" id="category-sidebar1">
                              <p>Location</p>
